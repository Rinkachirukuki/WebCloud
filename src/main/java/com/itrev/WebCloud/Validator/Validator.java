...
public class Validator {//Класс валидатора. Содержит методы проверки размера файла и формата файла.
    ...
    private static List<String> validTypes=Arrays.asList(new String[]{".png",".bmp",".jpeg",".docx",".doc",".xls",".xlsx",".ppt",".pptx",".pdf",".xml",".html",".mp3",".mp4"});
    ...
    public static boolean ValidateType(String name){//формат
        return validTypes.contains(name.substring(name.lastIndexOf(".")));
    }
